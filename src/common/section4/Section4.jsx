    ...
    >
      ...
      <div className="hidden md:flex relative z-20 flex-col items-start justify-start h-full pl-44">
        <div className="relative z-10 flex flex-col items-start p-8 md:p-12">
         ...
         className="reveal-on-scroll text-white text-3xl md:text-7xl pt-10 font-light leading-tight mb-6" style={{ fontFamily: 'Luxerie, sans-serif' }}>
        ...
        >{text1}</motion.p>}
          ...
          viewport={{ once: true }} className="reveal-on-scroll bg-white text-black px-6 py-2 rounded shadow font-medium hover:bg-gray-200 transition">
           {btntext}
         </motion.button>
        </div>
      </div>
