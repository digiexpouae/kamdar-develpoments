...
,
   ...
   {/* Slide 1 */}
                        ...
                        Why JVC is One of Dubai’s Most Desirable Places to Live and Invest?                                        </h2>
                            ...
                            >
                                <Image src={'/assets/Blog 2 image.jpg'} alt="Slide 1" fill className="object-cover" />
                                <div
                                    className="absolute inset-0 flex flex-col justify-end sm:justify-center p-6 sm:p-12 z-10"
                                    style={{
                                        background:
                                ...
                                >
                                    <div className="max-w-md">
                                        ...
                                        <h2
                                            ...
                                            className="text-white text-3xl font-semibold leading-[1] mt-3 mb-1 drop-shadow-lg"
                                        >
                                           Behind the Scenes: Designing 105 Residences
                                        </h2>
                                        {/* <p className="text-white text-md font-lexend mb-8 max-w-md drop-shadow-lg">
                                        ...
                                        <a href="/blogs/behind-the-scenes-designing-105-residences" target="_blank" rel="noopener noreferrer">
                                            <button
                                                style={{
                                                    border: '1px solid #A08741',
                                                    borderRadius: '7px',
                            ...
                            >
                                <Image src={'/assets/105/1.png'} alt="Slide 2" fill className="object-cover" />
                                <div
                                    className="absolute inset-0 flex flex-col justify-end sm:justify-center p-6 sm:p-12 z-10"
                                    style={{
                                        background:
                                ...
                                >
                                    <div className="max-w-md">
                                        ...
                                        <h2
                                            ...
                                            className="text-white text-3xl font-semibold leading-[1] mt-3 mb-1 drop-shadow-lg"
                                        >
                                            JVC Villas: A Rising Choice for Families<span style={{
                                                fontFamily: 'lexend',
                                                fontSize: '29px',
                                                fontWeight: '300',
                                            }}> </span>e for Families
                                        ...
                                        <a href="/blogs/jvc-villas-rise-in-demand" target="_blank" rel="noopener noreferrer">
                                            <button
                                                style={{
                                                    border: '1px solid #A08741',
                                                    borderRadius: '7px',
  ...
  <div
                            ...
                            >
                                <Image src={'/assets/105/1.png'} alt="Slide 3" fill className="object-cover" />
                                <div
                                    className="absolute inset-0 flex flex-col justify-end sm:justify-center p-6 sm:p-12 z-10"
                                    style={{
                                        background:
...
{/* 
                            ...
                            >
                                <Image src={kamdar} alt="Slide 8" fill className="object-cover" />
                                <div
                                    className="absolute inset-0 flex flex-col justify-end sm:justify-center p-6 sm:p-12 z-10"
                                    style={{
                                        background:
                                ...
                                >
                                    <div className="max-w-md">
                                        ...
                                        <h2
                                            ...
                                            className="text-white text-3xl font-semibold leading-[1] mt-3 mb-1 drop-shadow-lg"
                                        >
Casamia to shape premium interiors at Kamdar Developments’ 105 Residences
                                        </h2>
                                        <p className="text-white text-md font-lexend mb-8 max-w-md drop-shadow-lg">
Kamdar Developments has announced it will fit luxury Italian materials and surfaces from renowned interior solutions provider Casamia for its 105 Residences development.
                                        </p>
                                        <a href="https://www.constructionweekonline.com/people/appointments/casamia-kamdar-developments" target="_blank" rel="noopener noreferrer">
                                            <button
                                                style={{
                                                    border: '1px solid #A08741',
                                                    borderRadius: '7px',
                            ...
                            >
                                <Image src={Person} alt="Slide 8" fill className="object-cover" />
                                <div
                                    className="absolute inset-0 flex flex-col justify-end sm:justify-center p-6 sm:p-12 z-10"
                                    style={{
                                        background:
