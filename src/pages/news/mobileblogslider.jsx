        ...
        >
          ...
          <SwiperSlide>
            <div className="relative w-full h-full">
              <Image
                src={'/assets/Blog 1 Image (JVC).jpg'}
              ...
              <div className="absolute inset-0 flex flex-col max-w-[80%] justify-center p-6 text-white z-10">
               ...
               Why JVC is One of Dubai’s Most Desirable Places to Live and Invest?
                ...
                <a
                  href="/blogs/why-jvc-is-one-of-dubais-most-desirable-places-to-live-and-invest"
          ...
          <SwiperSlide>
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex flex-col max-w-[80%] justify-center p-6 text-white z-10">
                ...
                <h2 className="text-xl font-bold max-w-xl leading-[0.7] mt-5"
                style={{ fontFamily: 'Luxerie, Lexend, sans-serif' }}>
                 Behind the Scenes:Designing <span style={{ fontFamily: 'lexend',
                  fontSize:'17px',
                  fontWeight:'300',
             }}>  105 </span>Residences
                </h2>
                ...
                <a
                  href="/blogs/behind-the-scenes-designing-105-residences"
                  className="mt-4 px-5 py-2 border max-w-[120px] border-white text-sm rounded-md hover:bg-white hover:text-black transition"
                >
                  Read More
                </a>
          ...
          <SwiperSlide>
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex flex-col max-w-[80%] justify-center p-6 text-white z-10">
                ...
                <a
                  href="/blogs/jvc-villas-rise-in-demand"
                  className="mt-4 px-5 py-2 border max-w-[120px] border-white text-sm rounded-md hover:bg-white hover:text-black transition"
                >
                  Read More
                </a>
