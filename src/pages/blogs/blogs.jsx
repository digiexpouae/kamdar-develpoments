...
const dummyBlogs = [
    ...
    },
    {
      ...
      mainImage: 'https://source.unsplash.com/featured/?dubai,downtown,construction',
    },
    {
      ...
      mainImage: 'https://source.unsplash.com/featured/?dubai,jvc,villa',
    },
  ];
              ...
              <Link key={blog.slug} href={`/blogs/${blog.slug}`} className="group">
                <div className="bg-[#23262F] rounded-3xl shadow-md overflow-hidden flex flex-col h-full transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl border border-[#23262F] hover:border-[#CCAB64]">
                  ...
                  <div className="flex-1 flex flex-col p-6">
                    <h2 className="text-xl font-bold text-white mb-2 group-hover:text-white transition-colors duration-200">
                      {blog.title}
                    </h2>
